#!/usr/bin/env python3
"""Consolida a trajetória dos coeficientes até maio de 2025.

Objetivo: documentar convergência/instabilidade sem selecionar especificações
retrospectivamente. HHI usa quatro janelas comparáveis (jan-fev, jan-mar,
jan-abr, jan-mai). Gap valor-contagem e exposição Strength usam as três janelas
em que essas especificações estão versionadas (jan-mar, jan-abr, jan-mai).
"""
...
RES = ROOT / "results"
OUT = RES / "convergencia_coeficientes_jan_mai_2025"
...
ORDER = {"jan_fev": 2, "jan_mar": 3, "jan_abr": 4, "jan_mai": 5}
...
def main():
    ...
    later=d[d["janela"].isin(["jan_mar","jan_abr","jan_mai"])].copy()
    ...
    summary={
        ...
        "janelas_hhi":["jan_fev","jan_mar","jan_abr","jan_mai"],
        "janelas_exposicao_gap":["jan_mar","jan_abr","jan_mai"],
